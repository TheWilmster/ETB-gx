...
draw_roundrect_color_ext((SCALED_WIDTH * 0.5) - 80, (SCALED_HEIGHT * 0.5) - 100, (SCALED_WIDTH * 0.5) + 80, (SCALED_HEIGHT * 0.5) + 100, 10, 10, c_black, c_black, false);
for (var i = 0; i < array_length(pause_opt); i++) {
	draw_set_alpha((pause_alpha * (pause_select == i)) + (0.5 * pause_alpha));
	draw_text(SCALED_WIDTH * 0.5, ((SCALED_HEIGHT * 0.5) - ((24 * array_length(pause_opt)) * 0.5)) + (24 * i), pause_opt[i]);
}
draw_set_alpha(1);
