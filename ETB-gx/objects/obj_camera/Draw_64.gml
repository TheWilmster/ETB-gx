if (obj_player.state != 33)
{
    ...
    if (global.lapping == 1)
    {
        ...
        draw_text((SCALED_WIDTH / 2), 100, "Get back to the treasure room for 200 points!!")
    }
    ...
    if (timestop == 0)
    {
        if (global.seconds < 10)
        {
            if (global.minutes < 1)
                ...
                draw_set_color(c_white)
            draw_text(SCALED_WIDTH * 0.5, 65, ((string(global.minutes) + ":0") + string(global.seconds)))
        }
        else if (global.seconds >= 10)
        {
            if (global.minutes < 1)
                ...
                draw_set_color(c_white)
            draw_text(SCALED_WIDTH * 0.5, 65, ((string(global.minutes) + ":") + string(global.seconds)))
        }
    }
}
